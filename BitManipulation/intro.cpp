...
int main() {
  ...
  //
  // let's say for example we have 13 and we want to check that the 2nd bit is
  // set or not 13 == 1101 now we do left shift 2 to 1 so now it becomes 100
  //
  ...
  // we can also do the number given and right shift it by 1 so now the i'th bit
  // is at the unit's place and now we simply do 1 & num

  // now we are setting the bit to 1;
  // that can simply be done by OR'ing the whole thing by 1 bit right below the
  // i'th digit
  //
  // more like
  // 1 0 0 1
